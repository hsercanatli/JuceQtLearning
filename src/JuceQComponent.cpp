...
class JuceQComponent::Pimpl : public QObject, public ComponentMovementWatcher {
public:
    Pimpl(std::shared_ptr<QQuickView> w, Component &c)
        : ComponentMovementWatcher(&c), window(w) {
    ...
    std::shared_ptr<QQuickView> window;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(Pimpl)
};

JuceQComponent::JuceQComponent() = default;
JuceQComponent::~JuceQComponent() {}

void JuceQComponent::setWindow(std::shared_ptr<QQuickView> window) {
